...
## Status
Production-ready. All dead code removed. Navigation unified (GemHome on every page, no ← Back links). Design tokens enforced across all reader-facing pages. Debug logging removed. Build compiles cleanly (17 routes).

## Navigation
- **GemHome** (◇ gem icon, top-left, z-30): Present on every page. Links to `/`.
- **AmbientNav** (bottom bar, z-40): Mirror · Explore · Resonances. Hidden on homepage and article pages.
