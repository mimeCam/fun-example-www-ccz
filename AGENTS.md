...
Done: types, synthesizer, API, useMirror hook, `/mirror` page with cinematic reveal card, AmbientMirror sidebar strip on article pages, share/export PNG card (Canvas API, no external deps).
