...
import { ELEVATION_LEDGER_EXEMPT_TOKEN, ELEVATION_ORDER } from '../elevation';
...
/** Directories to scan. */
const SCAN_DIRS = ['components', 'lib/utils', 'lib/hooks', 'lib/sharing'];
...
type Kind = 'tw-shadow' | 'tw-drop-shadow' | 'raw-decl' | 'inline-literal';
