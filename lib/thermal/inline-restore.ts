...
el.setProperty('--token-bg',col(BG,BGW,t));
el.setProperty('--token-surface',col(SF,SFW,t));
el.setProperty('--token-foreground',col(FG,FGW,t));
el.setProperty('--token-accent',col(AC,ACW,t));
el.setProperty('--token-border',col(BD,BDW,t));
...
el.setProperty('--token-line-height',lerp(1.75,1.95,t).toFixed(3));
...
el.setProperty('--token-font-weight',lerp(400,500,t).toFixed(1));
el.setProperty('--token-letter-spacing',lerp(-.01,.02,t).toFixed(3)+'em');
el.setProperty('--token-para-rhythm',Math.round(lerp(0,12,t))+'px');
el.setProperty('--para-offset',Math.round(lerp(0,12,t)+t*14)+'px');
